...
beeline -u jdbc:hive2://rc1b-dataproc-m-52f2v3qpq6q2ydjz.mdb.yandexcloud.net:10000 -e "SELECT DISTINCT * FROM superjob_metrics WHERE group_name IS NOT NULL;" > superjob_metrics.csv
ENDSSH
